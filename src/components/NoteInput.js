        ...
        return (
            <div className="note-input">
                ...
                <form onSubmit={this.onSubmitHandler}>
                    ...
                    <textarea className="note-input__body" type="text" placeholder="Tuliskan Catatanmu disini ..." required value={this.state.body} onChange={this.onBodyChange}></textarea>
